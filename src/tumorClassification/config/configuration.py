...
class ConfigurationManager:
    ...
    def get_training_config(self) -> TrainingConfig:
        ...
        params = self.params
        training_data = os.path.join(self.config.data_ingestion.unzip_data_dir, "CT-KIDNEY-DATASET-Normal-Cyst-Tumor-Stone")
        create_directories([
    ...
    def get_model_evaluation_config(self)-> EvaluationConfig:
        eval_config=EvaluationConfig(
            ...
            mlflow_uri="https://dagshub.com/avinash8/kidney-Disease-Classification-using-MLOps.mlflow",
